--First Responder Kit Unistaller Script

--Configuration Parameters

DECLARE @allDatabases bit = 0;  --Flip this bit to 1 if you want to unistall the scripts from all the databases, not only the current one
