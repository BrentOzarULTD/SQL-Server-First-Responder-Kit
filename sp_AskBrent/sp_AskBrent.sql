...
AS 
	...
	*/
	...
	SELECT @Version = 3, @VersionDate = '2013/08/23'

	IF @OutputType = 'SCHEMA'
	BEGIN
		SELECT @Version AS Version,
		FieldList = '[Priority] TINYINT, [FindingsGroup] VARCHAR(50), [Finding] VARCHAR(200), [URL] VARCHAR(200), [Details] NVARCHAR(4000), [HowToStopIt] NVARCHAR(MAX), [QueryText] NVARCHAR(MAX)'
...
/* Commenting out this check for v3 because it only works with SQL Server 2012.
