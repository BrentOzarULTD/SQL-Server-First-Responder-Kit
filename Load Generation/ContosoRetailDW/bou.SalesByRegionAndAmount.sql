...
IF OBJECT_ID('bou.SalesByRegionAndAmount')IS NULL
	EXEC ('CREATE PROCEDURE bou.SalesByRegionAndAmount AS RETURN 0');
GO



ALTER PROCEDURE bou.SalesByRegionAndAmount
...
AS
 ...
 SELECT pc.[ProductCategoryName],
	...
	WHERE g.GeographyKey=@GeographyKey
		and f.SalesAmount between @AmountLow and @AmountHigh;
GO
